...
public class ListLessonDetailItem {
    ...
    public final String text2;  // the text for the ListView item text
    ...
    public ListLessonDetailItem(String image, String name, String text, String text2, String ltext, String rtext, String utext, String dtext, String description) {
        this.image = image;
        this.name = name;
        this.text = text;
        this.text2 = text2;
